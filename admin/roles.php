...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ── Delete role ──────────────────────────────────────────────────────────
        ...
        if ($role && in_array($role['slug'], ['admin', 'cashier'])) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                ...
                                <?php if (!in_array($role['slug'], ['admin', 'cashier'])): ?>
...
function openRoleModal(action, role) {
    ...
    if (action === 'add') {
        ...
        document.getElementById('roleSlug').readOnly = ['admin','cashier'].includes(role.slug);
    }
