...
<style>
    ...
    /* Camera scan button - Modern inline inside search */
    .pos-camera-btn {
        position: absolute;
        right: 8px;
        top: 50%;
...
<div class="modal-overlay" id="cameraScanModal">
    <div class="modal" style="max-width: 500px; border-radius: 20px; overflow: hidden; box-shadow: 0 25px 80px rgba(0,0,0,0.35);">
        <div class="modal-header" style="background: linear-gradient(135deg, #6366f1, #8b5cf6); color: #fff; border: none; padding: 1.2rem 1.5rem;">
            <h3 class="modal-title" style="color: #fff; font-weight: 800;"><i class="fas fa-barcode" style="margin-right: 0.5rem;"></i> Barcode Scanner</h3>
            <button class="modal-close" onclick="closeCameraScan()" style="color: #fff; font-size: 1.5rem; opacity: 0.8;">&times;</button>
        </div>
        <div class="modal-body" style="padding: 1.5rem; background: #0f172a; position: relative;">
            <div style="position: relative; border-radius: 16px; overflow: hidden; border: 3px solid #6366f1;">
                <div id="cameraScanReader" style="width: 100%;"></div>
                <div style="position: absolute; inset: 0; pointer-events: none;">
                    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 70%; height: 2px; background: linear-gradient(90deg, transparent, #22d3ee, #22d3ee, transparent); box-shadow: 0 0 15px #22d3ee; animation: scanLine 2s ease-in-out infinite;"></div>
                </div>
            </div>
            <div style="text-align: center; margin-top: 1rem; display: flex; align-items: center; justify-content: center; gap: 0.5rem;">
                <span style="display: inline-block; width: 8px; height: 8px; border-radius: 50%; background: #22d3ee; animation: blink 1.5s infinite;"></span>
                <span style="color: #94a3b8; font-size: 0.85rem; font-weight: 600;">Point camera at product barcode</span>
            </div>
        </div>
        <div class="modal-footer" style="border-top: 1px solid #1e293b; padding: 1rem 1.5rem; background: #1e293b;">
            <button class="btn" onclick="closeCameraScan()" style="background: linear-gradient(135deg, #6366f1, #8b5cf6); color: #fff; border: none; padding: 0.6rem 1.5rem; border-radius: 10px; font-weight: 700; cursor: pointer; transition: all 0.2s;">
                <i class="fas fa-times-circle"></i> Close Scanner
            </button>
        </div>
    </div>
</div>
